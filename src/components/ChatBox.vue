    ...
    <div v-if="isJoin" class="enter code mt-3">
      <v-row align="center" justify="center">
        <v-card width="500" class="px-8 py-5">
          <v-row >
            <h4>Code : {{ user }}</h4>
            <v-btn style="text-transform: unset !important;font-size: 12px;" class="mx-5" variant="outlined" v-clipboard:copy="user" height="25">Copy</v-btn>
          </v-row>
        </v-card>
      </v-row>
    ...
    <div v-if="isStartMsg" class="mt-3">
      <v-row align="center" justify="center">
        <v-card width="500" class="px-8 py-5">
          <v-row >
            <h4>Code : {{ code }}</h4>
            <v-btn style="text-transform: unset !important;font-size: 12px;" class="mx-5" variant="outlined" v-clipboard:copy="code" height="25">Copy</v-btn>
          </v-row>
        </v-card>
      </v-row>
